			...
			<div>
				...
				<div className="form-group row">
					...
					<div className="col-sm-2">
						<DatePicker className="form-control" dateFormat="YYYY-MM-DD" id="stamp" name="stamp" value={this.props.stamp}  selected={this.props.stamp || ''} onChange={this.props.dateChange}  />
					</div>
					<label htmlFor="date_modified" className="col-sm-1 col-form-label">Date: </label>
					<div className="col-sm-3">
						<DatePicker className="form-control" dateFormat="YYYY-MM-DD" id="date_modified" name="date_modified" value={this.props.date_modified} selected={this.props.date_modified || ''} onChange={this.props.dateModifiedChange}  />
					</div>
				</div>
				...
				<div className="form-group row">
					...
					<div className="col-sm-6">
						<input type="text" className="form-control" id="brokerage" name="brokerage" value={this.props.brokerage || ''} onChange={this.props.inputChange} />
					</div>
				</div>
				...
				<div className="form-group row">
					...
					<div className="col-sm-2">
					<input type="text" className="form-control" id="city" name="city" value={this.props.city || ''} onChange={this.props.inputChange} />
					</div>
					<label htmlFor="state" className="col-sm-1 col-form-label">State: </label>
					<div className="col-sm-3">
					<input type="text" className="form-control" id="state" name="state" value={this.props.state || ''} onChange={this.props.inputChange} />
					</div>
				</div>
				...
				<div className="form-group row">
					...
					<div className="col-sm-6">
						<input type="text" className="form-control" id="vendor" name="vendor" value={this.props.vendor || ''} onChange={this.props.inputChange} />
					</div>
				</div>

				<div className="form-group row">
					<div className="col-sm-12">
						<input type="text" className="form-control" id="question" name="question" placeholder="question" value={this.props.question || ''} onChange={this.props.inputChange} />
					</div>
				</div>

				<div className="form-group row">
					<div className="col-sm-12">
						<textarea  type="text" className="form-control" id="answer" name="answer" placeholder="answer" value={this.props.answer || ''} onChange={this.props.inputChange} />
					</div>
				</div>
			</div>
		)
